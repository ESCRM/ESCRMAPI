...
{
    /// <summary>
    /// Summary description for Outlook2CRM
    /// </summary>
    ...
    public class Outlook2CRM : System.Web.Services.WebService
    {
        /// <summary>
        /// Sharing levels
        /// </summary>
        ...
        public System.Collections.Generic.List<Outlook_Organisation> GetOrganisations(string UserId)
        {
            ...
            foreach (Organisation o in sql.Organisations_getOrganisations(1))
            {
                ...
                _GetOrganisations(ref oo, ref sql);
        ...
        private void _GetOrganisations(ref Outlook_Organisation parent, ref SQLDB sql)
        {
            System.Collections.Generic.List<Outlook_Organisation> retval = new System.Collections.Generic.List<Outlook_Organisation>();
            foreach (Organisation o in sql.Organisations_getOrganisations(parent.Id))
            {
                Outlook_Organisation ol = new Outlook_Organisation(o.Id, TypeCast.ToInt(o.ParentId), o.Name);
                _GetOrganisations(ref ol, ref sql);
                retval.Add(ol);
            }
            parent.Children = retval.ToArray();
        }
